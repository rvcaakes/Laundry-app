...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void setInitLayout() {
        ...
        historyAdapter = new HistoryAdapter(this, modelLaundryList);
    ...
    private void setViewModel() {
        ...
        String namaUser = sessionManager.getUserName(); // ✅ dari session

        laundryViewModel = ViewModelProviders.of(this)
                .get(LaundryViewModel.class);

        laundryViewModel.getDataLaundryByUser(namaUser)
                .observe(this, modelLaundryList -> {
                    if (modelLaundryList != null && modelLaundryList.size() > 0) {
