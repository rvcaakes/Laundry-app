package com.azhar.laundry.view.premiumwash;
...
public class PremiumWashActivity extends AppCompatActivity {
    ...
    private void loadAllPricesFromApi() {
        loadHargaItem("Premium Wash", "Kaos");
        loadHargaItem("Premium Wash", "Jeans");
        loadHargaItem("Premium Wash", "Jaket");
        loadHargaItem("Premium Wash", "Bed Cover");
        loadHargaItem("Premium Wash", "Karpet");
    }
        ...
        apiService.getPriceByCategoryAndItem(category, item)
                .enqueue(new Callback<ModelPrice>() {
                    ...
                    public void onFailure(Call<ModelPrice> call, Throwable t) {
                        Toast.makeText(PremiumWashActivity.this,
     ...
     private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                ...
                Intent intent = new Intent(PremiumWashActivity.this, KonfirmasiPesananActivity.class);
                intent.putExtra("alamat", "");
                intent.putExtra("items", items);
                intent.putExtra("total", (int) totalPrice);
                intent.putExtra("category", "Premium Wash");
