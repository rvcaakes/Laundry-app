...
public class CuciBasahActivity extends AppCompatActivity {
    ...
    private void loadAllPricesFromApi() {
        loadHargaItem("Cuci Basah", "Kaos");
        loadHargaItem("Cuci Basah", "Jeans");
        loadHargaItem("Cuci Basah", "Jaket");
        loadHargaItem("Cuci Basah", "Bed Cover");
        loadHargaItem("Cuci Basah", "Karpet");
    }
        ...
        apiService.getPriceByCategoryAndItem(category, item)
                .enqueue(new Callback<ModelPrice>() {
                    ...
                    public void onFailure(Call<ModelPrice> call, Throwable t) {
                        Toast.makeText(CuciBasahActivity.this,
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                ...
                Intent intent = new Intent(CuciBasahActivity.this, KonfirmasiPesananActivity.class);
                intent.putExtra("alamat", "");
                intent.putExtra("items", items);
                intent.putExtra("total", (int) totalPrice);
                intent.putExtra("category", "Cuci Basah");
