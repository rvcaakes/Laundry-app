...
public class DryCleanActivity extends AppCompatActivity {
    ...
    private void loadAllPricesFromApi() {
        loadHargaItem("Dry Cleaning", "Kaos");
        loadHargaItem("Dry Cleaning", "Jeans");
        loadHargaItem("Dry Cleaning", "Jaket");
        loadHargaItem("Dry Cleaning", "Bed Cover");
        loadHargaItem("Dry Cleaning", "Karpet");
    }
        ...
        apiService.getPriceByCategoryAndItem(category, item)
                .enqueue(new Callback<ModelPrice>() {
                    ...
                    public void onFailure(Call<ModelPrice> call, Throwable t) {
                        Toast.makeText(DryCleanActivity.this,
     ...
     private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                ...
                Intent intent = new Intent(DryCleanActivity.this, KonfirmasiPesananActivity.class);
                intent.putExtra("alamat", "");
                intent.putExtra("items", items);
                intent.putExtra("total", (int) totalPrice);
                intent.putExtra("category", "Dry Cleaning");
